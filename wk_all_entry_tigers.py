...
if __name__=='__main__':
    ...
    # while True:
        ...
        for _k, news in enumerate(soup.findAll('section', class_='bb-modCommon02')):
            ...
            if _team is None:
                ...
                with open(csvdir+f'/catcher_stats{_y}t.csv',mode='a',encoding='shift-jis') as f:
        ...
        if int(input('敵チームの盗塁企図あり? (1:YES, 0:NO)> ')):
            ...
            while nextrunner:
                ...
                with open(csvdir+f'/stolen_stats{_y}t.csv',mode='a',encoding='shift-jis') as f:
        ...
        if int(input('阪神にバッテリーエラーあり？(1:YES, 0:NO)> ')):
            ...
            while nextbattery:
                ...
                with open(csvdir+f'/pitch_stats{_y}t.csv',mode='a',encoding='shift-jis') as f:
        ...
        DATATABLESDEMO = f'./assets/demo/datatables-demo{_y}t.js'
    ...
    # if False:
        ...
        replace_table('catcher_stats', f'catcher_stats{_y}t.csv')
        replace_table('stolen_stats', f'stolen_stats{_y}t.csv')
        ...
        atag_tweet_html = '\t'*7 + f'<a href="http://twitter.com/share?text={_y}阪神捕手別投手成績%0D%0A捕手, 勝-敗-S, 防御率 (イニング)%0D%0A'
        for catcher_stat in catcher_stats[1:]:
