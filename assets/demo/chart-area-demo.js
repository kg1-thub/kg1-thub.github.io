var ctx26_data = {
  'Giants':  [0,  1,  0, -1,  0,//wl_Giants
  ],
  'Tigers':  [0, -1,  0,  1,  2,//wl_Tigers
  ],
  'Baystars':[0, -1, -2, -3, -4,//wl_Baystars
  ],
  'Swallows':[0,  1,  2,  3,  4,//wl_Swallows
  ],
  'Dragons': [0, -1, -2, -3, -4,//wl_Dragons
  ],
  'Carp':    [0,  1,  2,  3,  2,//wl_Carp
  ],
  'labels':[
