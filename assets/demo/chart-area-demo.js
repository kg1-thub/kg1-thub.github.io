var ctx25_data = {
  'Giants':  [0,  1,  2,  3,  2,  3,  4,//wl_Giants
  ],
  'Tigers':  [0,  1,  2,  1,  0,  0, -1,//wl_Tigers
  ],
  'Baystars':[0,  1,  0,  1,  2,  2,  3,//wl_Baystars
  ],
  'Swallows':[0, -1, -2, -3, -3, -2, -1,//wl_Swallows
  ],
  'Dragons': [0, -1,  0, -1,  0, -1, -2,//wl_Dragons
  ],
  'Carp':    [0, -1, -2, -1, -1, -2, -3,//wl_Carp
  ],
  'labels':[
