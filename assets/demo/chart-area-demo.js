...
var ctx21_data = {
  ...
  'labels':[
    ...
    '05/02','05/03','05/04','05/05','05/07','05/08','05/09','05/11',
    // '05/12',
    // '05/13',
    // '05/14',
    // '05/15',
...
var myLineChart21 = new Chart(ctx21, {
  ...
  options: {
    ...
    //   delay: (ctx21) => {
    //     let delay = 0;
    //     if (ctx21.type === 'data' && !delayed) {
    //       delay = ctx21.dataIndex * 300 + ctx21.datasetIndex * 100;
    //       console.log(delay);
    //     }
    //     return delay;
    //   },
