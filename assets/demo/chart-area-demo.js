var ctx25_data = {
  'Giants':  [0,  1,  2,  3,  2,  3,//wl_Giants
  ],
  'Tigers':  [0,  1,  2,  1,  0,  0,//wl_Tigers
  ],
  'Baystars':[0,  1,  0,  1,  2,  2,//wl_Baystars
  ],
  'Swallows':[0, -1, -2, -3, -3, -2,//wl_Swallows
  ],
  'Dragons': [0, -1,  0, -1,  0, -1,//wl_Dragons
  ],
  'Carp':    [0, -1, -2, -1, -1, -2,//wl_Carp
  ],
  'labels':[
    'Start','03/28','03/29','03/30','04/01','04/02','04/03','04/04','04/05','04/06',
    // '04/07','04/09','04/10','04/11','04/12',
...
var ctx25p_data = {
  'Hawks':    [0, -1, -2, -3, -2, -3,//wl_Hawks
  ],
  'Fighters': [0,  1,  2,  3,  2,  3,//wl_Fighters
  ],
  'Marines':  [0,  1,  2,  3,  3,  2,//wl_Marines
  ],
  'Eagles':   [0, -1,  0, -1, -1, -1,//wl_Eagles
  ],
  'Buffaloes':[0,  1,  0,  1,  1,  2,//wl_Buffaloes
  ],
  'Lions':    [0, -1, -2, -3, -3, -3,//wl_Lions
  ],
  'labels':[
    'Start','03/28','03/29','03/30','04/01','04/02','04/03','04/04','04/05','04/06',
    // '04/07','04/09','04/10','04/11','04/12',
