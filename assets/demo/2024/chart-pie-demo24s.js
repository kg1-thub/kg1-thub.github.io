...
var pie_data24 = {'Catcher': ['中村', '松本直', '内山', 'その他'], 'stolen_bases': [24, 15, 1, 3], 'Defense_inning': [[27.0, 179.0, 189.0, 83.0, 119.33, 37.67, 134.0, 15.0], [3.0, 10.0, 27.33, 94.67, 57.33, 111.67, 29.0, 10.0], [0, 0, 0, 0, 0, 41.33, 48.0, 0], [0, 12.0, 2.0, 12.0, 0, 16.0, 0, 1.0]], 'Starting_games': [[3, 21, 21, 10, 13, 5, 16, 2], [0, 1, 3, 11, 7, 13, 3, 1], [0, 0, 0, 0, 0, 4, 5, 0], [0, 1, 0, 1, 0, 2, 0, 0]], 'Winning_games': [[2, 9, 7, 5, 5, 1, 9, 1], [0, 0, 0, 7, 2, 8, 2, 0], [0, 0, 0, 0, 0, 0, 3, 0], [0, 0, 0, 1, 0, 0, 0, 0]]};
var catchers = ['中村', '松本直', '内山'];
